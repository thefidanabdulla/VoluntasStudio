  ...
  return (
    <div className='w-full flex justify-center bg-[#292E32]'>
      <div className='w-full xl:max-w-[1200px] px-4 xl:px-0 py-[100px]'>
        <div className='flex flex-col md:flex-row justify-center md:items-start items-center md:justify-between gap-8 flex-wrap'>
          <div className='w-[200px]'>
            <Image src={voluntasLogo} alt='voluntas logo' />
          </div>
          <div className=' flex flex-col items-start gap-2 md:gap-4 flex-shrink-0'>
            <Link href={'/'} className='text-white md:text-xl hover:text-[#f6dc41] transition-all'>Home</Link>
            <Link href={'/about'} className='text-white md:text-xl hover:text-[#f6dc41] transition-all'>About</Link>
            <Link href={'/team'} className='text-white md:text-xl hover:text-[#f6dc41] transition-all'>Team</Link>
            <Link href={'/contact'} className='text-white md:text-xl hover:text-[#f6dc41] transition-all'>Contact</Link>
          </div>
